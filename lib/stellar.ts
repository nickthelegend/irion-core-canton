...
export const CONTRACTS = {
  irionCore:
    ...
    "CCNJPKMUANQHHJ2H4XS4NDVMZ4KFH3IRYM6AMZGBKYD55KCX4UMPOS2C",
  usdc:
  ...
  groth16Verifier:
    ...
    "CCI7TRMTRXPJF6OEJT4WDPWKYJ3PBRYYVAXTTVXN7JW4JNAXB5CUGWDT",
};
...
// Re-export the StrKey helper so UI can validate Stellar addresses without
